...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lccc@{}}
		...
		Huang et al. (2023)     & Ensemble RF+GB+SVM+KNN   & 5.15       & 0.927 \\
		Bouabdallaoui et al. (2023) & MLP                  & 5.3        & 0.924 \\
		Kolev y Sulakov (2019)  & Gradient Boosting     & 6.02 MW    & 0.765 \\
		\textbf{Este trabajo}   & \textbf{MLP + LR (90/10)} & \textbf{0.4287} & \textbf{0.8234} \\
		\bottomrule
	\end{tabular}
