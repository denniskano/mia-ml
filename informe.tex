...
\begin{document}
	...
	\textbf{Complementos específicos}:
	\begin{itemize}[leftmargin=*,itemsep=1pt]
		\item \textbf{2024 - CNN-BiLSTM + AR}: modelo híbrido secuencial con autoregresión, afín a nuestro enfoque combinado MLP + regresión.
		\item \textbf{2024 - Adaptive ML}: propone un sistema dinámico multi-algoritmo, alineado con nuestras decisiones de ponderación.
		\item \textbf{2021 - WRF en Brasil}: estudio basado en WRF que motiva el uso de fuentes meteorológicas de alta resolución.
	\end{itemize}
	
	Estos estudios sustentan las decisiones metodológicas tomadas en nuestro enfoque, desde el diseño del pipeline hasta la validación de ensembles y detección de anomalías.
